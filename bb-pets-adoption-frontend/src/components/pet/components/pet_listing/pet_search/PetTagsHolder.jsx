...
import useFetchPets from "../../../../../components/hooks/data/fetchPets";
...
const PetTagsHolder = () => {
    ...
    //  const { loadMoreFiltered } = useFetchPets(tagsList);

    // use 'DataPetContext' to reset petsData when a new pet filtered search is requested by theuser
    const { resetPetsData, setTagsList } = useContext(DataPetContext);
